...
as well as the indexes which appear in $\bm{s}$-pairs of depth at least $6$.
...
Then we can make in addition one of the following assumptions:
...
The two cases (\ref{graph}) and (\ref{finite}) will be done separately.
