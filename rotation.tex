...
if the the arc $\tilde\gamma_p|_{[a,b]}$
...
\end{align*}
Therefore, 
to violete Main Theorem 
$\gamma$ has to cross the  horisons $\omega_{\bm{i}}$, $\omega_{\bm{j}}$ and $\omega_{\bm{k}}$ huge number of times.
...
By Claim~\ref{clm:7.3}, $\phi_n$ is nondecreasing,
