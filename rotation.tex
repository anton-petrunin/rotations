...
Then we can assume in addition that $\Sigma_n$ is smooth and $\gamma_n'(t)$ is arbitrary close to a constant vector.
\end{thm}
...
By Lemma \ref{lem:diam-length} $\length\gamma_n<4$.
Therefore we can subdivide $\gamma_n$ into say 100000 arcs
such that the legth of each arc is at most $\tfrac1{100}$
and it lies on the distance $1\pm \tfrac1{100}$ 
from a point $p\in K_n$.
Choose among them the arc with the maximal total curvature and 
name it $\gamma_n$ and translate whole space so the corresponding point $p$ becomes the origin;
we still have that $\tc\gamma_n\to \infty$ as $n\to \infty$.

Let us apply Liberman's Lemma to $\gamma_n$ and reference point $p_n$.
We get that $\tc_p\gamma_n<\pi+\tfrac1{10}$.
Therefore we can divide $\gamma_n$ into say 100000 arcs again so that 
total curvature of each arc in direction of $p_n$ is at most $\tfrac 1{100}$.
In particular on each arc the angle between $\gamma(t)$ and $\gamma'(t)$ is a constant $\pm \tfrac 1{100}$.
Choose among the arcs the one which has maximal total curvature and 
name it $\gamma_n$ again;
we still have that $\tc\gamma_n\to \infty$ as $n\to \infty$;
denote by $\alpha$ the angle between $\gamma(t)$ and $\gamma'(t)$ at some point of the arc.

If $\alpha$ is sufficiently close to $\pi$ or $0$ then $\gamma_n$ runs almost in the direction of $\pm\gamma(t)$;
in this case we finished the proof.

Assume $\alpha$ is sufficiently far from $\pi$ and $0$.
Applying Lemma \ref{lem:eps-straight} we get a nondegenerate (say isosceles and right-angled) 
triangle $\triangle a_1a_2a_3$ in $K_n$ 
of the size comparable to $\diam \gamma$ and on the distance comparable to $\diam \gamma$ from $\gamma$.

Apply the construction to each vertex of the triangle.
We pass to an arc of $\gamma_n$
such that the angle between $\gamma'(t)$ and $a_i-\gamma(t)$ is nearly constant for each $i$.
The later imply that $\gamma'$ is nearly constant.
\qeds
